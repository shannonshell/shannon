...
Shannon is an AI-first poly-shell — use bash, brush, nushell, fish, zsh, and
...
- [Shell Switching](features/01-shell-switching.md) — Shift+Tab between bash, brush, nushell, fish, zsh
...
- [Supported Shells](reference/03-supported-shells.md) — bash, brush (embedded), nushell (embedded), fish, zsh, custom

## Architecture

- [How Shannon Works](02-architecture.md) — embedded nushell + brush, subprocess wrappers, state capture
